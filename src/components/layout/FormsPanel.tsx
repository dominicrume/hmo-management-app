...
export default function FormsPanel({ activeForm, onSelectForm, tenant, completedForms, onPrintAll, activeTab = 'forms', onTabChange, workerId }: Props) {
  ...
  return (
    <aside
      className="w-full xl:w-[320px] xl:min-w-[320px] min-w-0 max-w-full xl:max-w-[320px] bg-slate-50 border-l border-slate-200 flex flex-col flex-1 xl:h-full min-h-0 overflow-hidden"
